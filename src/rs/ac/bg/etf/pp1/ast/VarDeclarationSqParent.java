...
public class VarDeclarationSqParent extends VarDecl {

    private VarDecl VarDecl;
    private String VarDeclName;

    public VarDeclarationSqParent (VarDecl VarDecl, String VarDeclName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclarationSqParent(\n");
