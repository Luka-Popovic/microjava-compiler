...
public class SingleFormalParameterList extends FormalParamList {

    private FormalParamDecl FormalParamDecl;

    public SingleFormalParameterList (FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleFormalParameterList(\n");
